...
describe("Test Products APIs", () => {
  ...
  it("should test that GET /products/:productId returns 200 and a body", async () => {
  ...
  it("Should test that GET /products/:productId returns 404 if the productId doesn't exist", async () => {
    await client.get(`/products/${invalidId}`).expect(404);
  });

  it("Should test that DELETE /products/:productId returns 204", async () => {
